function H = nrPerfectChannelEstimate_oneSymbol(varargin)
...
%#codegen
    ...
    T_min = max(T_min,symbolEnds(ofdminfo.SymbolsPerSlot));
    T_max = max(T_max,symbolEnds(ofdminfo.SymbolsPerSlot));
